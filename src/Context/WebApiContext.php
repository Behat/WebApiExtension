...
class WebApiContext implements WebApiAwareContext {
  ...
  public function iSendARequestWithValues($method, $url, TableNode $post) {
    ...
    $this->request = $this->client->createRequest($method, $url, $body_option);
    if (!empty($this->headers)) {
      $this->request->addHeaders($this->headers);
    }
  ...
  public function iSendARequestWithBody($method, $url, PyStringNode $string) {
    ...
    $this->request = $this->client->createRequest($method, $url, array(
  ...
  public function theResponseShouldContain($text) {
    $expected_regexp = '/' . preg_quote($text) . '/i';
    $actual = (string) $this->response->getBody();
    Assertions::assertRegExp($expected_regexp, $actual);
  }
  ...
  public function theResponseShouldNotContain($text) {
    $expected_regexp = '/' . preg_quote($text) . '/';
    $actual = (string) $this->response->getBody();
    Assertions::assertNotRegExp($expected_regexp, $actual);
  }
